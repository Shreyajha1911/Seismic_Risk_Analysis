...
**Data Ingestion**
Apache NiFi pulls from the USGS API every 5 minutes and stores JSON files in a MinIO (S3-compatible) bucket.

**Processing Pipeline (Apache Spark)**
- 📦 Batch Processing — Risk Index calculation (40% frequency + 60% severity)
- 📡 Structured Streaming — Live 5-minute tumbling windows with watermarking
- 🕸️ Graph Processing — GraphFrames + PageRank for portfolio correlation analysis
- 🤖 Machine Learning — KMeans clustering with PCA for risk tier classification
